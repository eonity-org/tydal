...
return [
     ...
     */
    'max_file_size' => env('MAX_MEDIA_FILE_SIZE', 300) * 1024 * 1024,
     ...
     * We use a custom path generator to organize files by resource ID.
     */
    'path_generator' => ResourcePathGenerator::class,
